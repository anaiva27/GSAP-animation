    ...
    <Wrapper ref={container} className="scroll">
      <Header>
        <Link href="" target="_blank" rel="noopener noreferrer">
          <Logo src={headerLogo} className="line" />
        </Link>
        <HeaderLeft>
          <p className="header">Fan Engagement</p>
          <p className="header"> Fan Manager</p>
          <p className="header"> Why SET</p>
          <p className="header"> Resources</p>
        </HeaderLeft>

        <HeaderCTA>
          <p className="header">Log In</p>
          <ButtonSecondary className="header">Get Started</ButtonSecondary>
        </HeaderCTA>
      </Header>

      <Content as="section" id="registration-content" src={bgImg}>
        <ContentContainer>
          <FormContent>
            ...
            <Body className="hero">
              Whether on social media or at shows, SET lets you get to know the
              fans most likely to stream your next release, buy your new merch
              and get to tickets to your next tour
            </Body>

            <ButtonSecondary className="hero">Get Started</ButtonSecondary>
            {/* <LottieWrap>
              <Lottie
          ...
          <ArtistImage
            ...
            className="img"
          >
            <img src={Img1} alt="" className="phone1" />
            <img src={Img2} alt="" className="phone2" />
            <img src={Img3} alt="" className="phone3" />
          </ArtistImage>
        </ContentContainer>
      </Content>

      <ContentCTA as="section" ref={containerCTA}>
        <SecondFormContent className="img2">
          <SubHeading>Trusted By Industry Leaders & 10k+ Artists.</SubHeading>
          <ImageRow>
          ...
          <Body className="bodyCTA">
            Join the roster of management companies, labels, artist services and
            more that use SET to supercharge data grabbing for fan-focused
            marketing efforts.
          </Body>
        </SecondFormContent>
        <ArtistImageRow isMobile={isMobile} as="section" id="artist-image">
          <img src={Artist1} alt="" className="artist" />
          <img src={Artist2} alt="" className="artist" />
          <img src={Artist3} alt="" className="artist" />
          <img src={Artist4} alt="" className="artist" />
          <img src={Artist5} alt="" className="artist" />
        </ArtistImageRow>
      </ContentCTA>

      <ContentSolution as="section">
        <ThirdFormContent>
          <SubHeading>A Solution For Everywhere Your Fans Are.</SubHeading>
          <Body>
            Don’t let ticketing platforms and social media algorithms get
            between you and your fans. SET’s tools put you back in control.
          </Body>
        </ThirdFormContent>
